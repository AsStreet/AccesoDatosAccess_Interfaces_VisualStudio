...
namespace AccesoDatosAccess
{
    public partial class Form1 : Form
    {
        ...
        private void btnConectar_Click(object sender, EventArgs e)
        {
            ...
            string sCnn = "Server=localhost; Database=" + txtBase.Text + ";Integrated Security=true";
            //string sCnn = "Data Source=localhost\\SQLExpress; Initial Catalog=" + txtBase.Text + "; User ID=sa; Password=oretania";
            ...
            try
            {
                ...
                // Colocar estas líneas cuando se trabaja con CommandBuilder
